...
Again using OSM data, it is possible to extract road data.
...
# create land raster
land_mask = rasterize(gran_canaria_vect,
                      template,
                      1,
                      background=NA)

# invert land raster (there is probs an easy way)
sea_mask = ifel(is.na(land_mask), 1,
                 ifel(land_mask == 1, NA,
                      land_mask))
